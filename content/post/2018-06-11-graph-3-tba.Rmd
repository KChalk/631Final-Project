...
A more common use of this graph is to show, within a a dataset, covariance between features. In that version, the features on each axis would be identical, and along the 
